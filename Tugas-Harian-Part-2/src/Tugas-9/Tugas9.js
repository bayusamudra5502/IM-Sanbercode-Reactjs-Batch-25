      ...
      <form action="#">
        ...
        <div>
          ...
          <div className="daftar-buah">
            ...
            <p className="pilihan-buah">
              <input type="checkbox" name="buahJeruk" id="jeruk" value="true" />
              <label htmlFor="jeruk">Jeruk</label>
            </p>
            <p className="pilihan-buah">
              <input type="checkbox" name="buahNanas" id="nanas" value="true" />
              <label htmlFor="nanas">Nanas</label>
            </p>
            <p className="pilihan-buah">
              <input type="checkbox" name="buahSalak" id="salak" value="true" />
